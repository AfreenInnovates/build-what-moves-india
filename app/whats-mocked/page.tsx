...
const ROWS = [
  ...
  ['The grievance and appeal ladder', 'Real', 'The rungs, the order they unlock in, the deadline arithmetic and the statutory references are held in one data module with a source and a last-checked date on every entry, exactly like the settlement timings. Which rung is open is derived from your own case events, not set by a button.'],
  ['The drafted grievance, appeal, RTI and HR letters', 'Real', 'Filled deterministically from your case — your UAN, your claim reference, your dates, the specific checks that failed. No language model writes any of them, because a fluent letter citing the wrong section of the RTI Act is worse than no letter.'],
  ['Filing a grievance, and its reply', 'Mocked', 'Nothing is transmitted to EPFiGMS, CPGRAMS or any government system. Registration numbers are generated locally. Advancing the demo clock returns the reply these grievances most commonly return — a disposal that closes the ticket without answering the question — because simulating the system working would teach nobody anything. Every draft is downloadable so you can file it yourself on the real portal, which each rung links to.'],
